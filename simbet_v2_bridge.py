...
def _shape_result(match: dict, pred: dict) -> dict:
    return {
        ...
        "home_missing_weighted": match.get("home_missing_weighted"),
        "away_missing_weighted": match.get("away_missing_weighted"),
        "home_missing_players": match.get("home_missing_players"),
        "away_missing_players": match.get("away_missing_players"),
